...
import { SocialShared, ButtonGeneric } from "../../components/common";
...
export const AmpliadoRondasVinculacion = () => {
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-7 col-12">
                <figure>
                  <img className="img-fluid" src={ImageStand} alt="" />
                </figure>

                <p className="proyectDescription">
                  The chairman of TCL Technology Group Corp said a trader
                  accidentally sold 5 million company shares using his account
                  an incident that comes. The sale was made at 1:03 p.m. Tuesday
                  by a trader managing chairman Li Dongsheng’s accounts who had
                  typed in the wrong stock code, the Guangdong-based panel maker
                  said in a filing to the Shenzhen exchange. Li bought back the
                  shares for 35.8 million yuan ($5.2 million) less than two
                  hours after the trader sold them for 35.9 million ydseen, the
                  firm said.
                </p>
                ...
                <div className="detailRonda">
                  ...
                  <div className="containerMail">
                    ...
                    <a
                      ...
                      href="mailto:clarika@clarika.com"
                    >
                      mcsuarez@gmail.com
                    </a>
                  </div>
